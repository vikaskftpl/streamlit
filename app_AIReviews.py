...
if st.button('Click to get AI Reviews'):
    if tgt_text == '':    
        ...
        batch = tokenizer.prepare_seq2seq_batch(tgt_text,truncation=True,padding='longest',max_length=1000, return_tensors="pt")
        #translated = model.generate(**batch,max_length=60,num_beams=10, num_return_sequences=10, temperature=1.5)
        translated = model.generate(**batch,max_length=40,num_beams=10, num_return_sequences=10, temperature=1.5)
